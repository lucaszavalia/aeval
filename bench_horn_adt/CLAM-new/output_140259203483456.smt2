...
(declare-datatypes ((listOfInt 0)) (((cons-listOfInt (param2 Int) (param3 listOfInt))(nil-listOfInt))))
(declare-fun append (listOfInt listOfInt ) listOfInt)
(assert (forall ((|_FH_2'| listOfInt)) (= (append nil-listOfInt |_FH_2'|) |_FH_2'|)))
(assert (forall ((A Int) (_FH_0 listOfInt) (_FH_1 listOfInt)) (= (append (cons-listOfInt A _FH_0) _FH_1) (cons-listOfInt A (append _FH_0 _FH_1)))))
...
(check-sat)(set-logic ALL)
(declare-datatypes ((listOfInt 0)) (((cons-listOfInt (param4 Int) (param5 listOfInt))(nil-listOfInt))))
(declare-fun append (listOfInt listOfInt ) listOfInt)
...
(check-sat)(set-logic ALL)
(declare-datatypes ((listOfInt 0)) (((cons-listOfInt (param6 Int) (param7 listOfInt))(nil-listOfInt))))
(declare-fun append (listOfInt listOfInt ) listOfInt)
(declare-fun rev (listOfInt ) listOfInt)
(assert (forall ((|_FH_2'| listOfInt)) (= (append nil-listOfInt |_FH_2'|) |_FH_2'|)))
(assert (forall ((A Int) (_FH_0 listOfInt) (_FH_1 listOfInt)) (= (append (cons-listOfInt A _FH_0) _FH_1) (cons-listOfInt A (append _FH_0 _FH_1)))))
...
(check-sat)(set-logic ALL)
(declare-datatypes ((listOfInt 0)) (((cons-listOfInt (param8 Int) (param9 listOfInt))(nil-listOfInt))))
(declare-fun append (listOfInt listOfInt ) listOfInt)
(declare-fun rev (listOfInt ) listOfInt)
(assert (forall ((|_FH_2'| listOfInt)) (= (append nil-listOfInt |_FH_2'|) |_FH_2'|)))
(assert (forall ((A Int) (_FH_0 listOfInt) (_FH_1 listOfInt)) (= (append (cons-listOfInt A _FH_0) _FH_1) (cons-listOfInt A (append _FH_0 _FH_1)))))
