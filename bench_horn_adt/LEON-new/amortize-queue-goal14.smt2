...
; conjecture
(assert (forall ((x Lst) (y Lst) (n Int) (z Lst) (u Lst) (v Lst) (q Queue))
	(=> (and (queue-to-lst (queue x y) z) (append z (cons n nil) u) (enqueue (queue x y) n q) (queue-to-lst q v)
		(not (= u v))) false))); G-amortize-queue-14 
(check-sat)
